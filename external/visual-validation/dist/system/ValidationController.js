...
System.register(['./VSBindingUtils', './BindingFunctions', 'aurelia-framework', './SigaValidationFactory'], function (_export, _context) {
  "use strict";

  var VSBindingUtils, getPropertyInfo, inject, Container, singleton, TaskQueue, MonitoredComponentFactory, _dec, _class, ValidationError, ValidationController, MonitoredComponent;
  ...
  return {
    setters: [function (_VSBindingUtils) {
      VSBindingUtils = _VSBindingUtils.VSBindingUtils;
    }, function (_BindingFunctions) {
      getPropertyInfo = _BindingFunctions.getPropertyInfo;
    }, function (_aureliaFramework) {
      inject = _aureliaFramework.inject;
      Container = _aureliaFramework.Container;
      singleton = _aureliaFramework.singleton;
      TaskQueue = _aureliaFramework.TaskQueue;
    }, function (_SigaValidationFactory) {
      MonitoredComponentFactory = _SigaValidationFactory.MonitoredComponentFactory;
    }],
    execute: function () {
      _export('ValidationError', ValidationError = function () {
      ...
      _export('ValidationController', ValidationController = (_dec = inject(VSBindingUtils, Container, MonitoredComponentFactory), _dec(_class = function () {
            ...
            return regeneratorRuntime.wrap(function _callee2$(_context4) {
              while (1) {
                switch (_context4.prev = _context4.next) {
                  ...
                  case 12:
                    return _context4.abrupt('return', { valid: valid });
      ...
      _export('MonitoredComponent', MonitoredComponent = function () {
              ...
              while (1) {
                switch (_context5.prev = _context5.next) {
                  ...
                  case 20:
                    ...
                    return _context5.abrupt('return', isError);
      ...
      _export('MonitoredComponent', MonitoredComponent);
    }
  };
});