...
System.register(['aurelia-framework', 'aurelia-event-aggregator'], function (_export, _context) {
  ...
  var inject, bindable, EventAggregator, _dec, _class, _desc, _value, _class2, _descriptor, _descriptor2, Testa;
  ...
  return {
    ...
    execute: function () {
      _export('Testa', Testa = (_dec = inject(EventAggregator), _dec(_class = (_class2 = function () {
        function Testa(ea) {
