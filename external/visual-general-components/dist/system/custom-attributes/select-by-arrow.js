...
System.register(['aurelia-framework'], function (_export, _context) {
  ...
  var inject, bindable, _dec, _class, _desc, _value, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, SelectByArrowCustomAttribute;
  ...
  return {
    ...
    execute: function () {
      _export('SelectByArrowCustomAttribute', SelectByArrowCustomAttribute = (_dec = inject(Element), _dec(_class = (_class2 = function () {
      ...
      _export('SelectByArrowCustomAttribute', SelectByArrowCustomAttribute);
    }
  };
});