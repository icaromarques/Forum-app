...
System.register(['aurelia-framework'], function (_export, _context) {
  ...
  var inject, bindable, _dec, _class, _desc, _value, _class2, _descriptor, _descriptor2, _descriptor3, ViewStackCustomAttribute;
  ...
  return {
    ...
    execute: function () {
      _export('ViewStackCustomAttribute', ViewStackCustomAttribute = (_dec = inject(Element), _dec(_class = (_class2 = function () {
      ...
      _export('ViewStackCustomAttribute', ViewStackCustomAttribute);
    }
  };
});