...
System.register(['aurelia-framework'], function (_export, _context) {
  ...
  var inject, bindable, bindingMode, _dec, _dec2, _class, _desc, _value, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, VisualFileInputCustomElement;
  ...
  return {
    ...
    execute: function () {
      _export('VisualFileInputCustomElement', VisualFileInputCustomElement = (_dec = inject(Element), _dec2 = bindable({ defaultBindingMode: bindingMode.twoWay }), _dec(_class = (_class2 = function () {
      ...
      _export('VisualFileInputCustomElement', VisualFileInputCustomElement);
    }
  };
});